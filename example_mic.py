...
def transcribe(model="small", language=None, mic_energy=None, pause_duration=None, mic_dynamic_energy=None, stop_word=None):
...
if __name__ == "__main__":
    transcribe(model="small", pause_duration=1)
